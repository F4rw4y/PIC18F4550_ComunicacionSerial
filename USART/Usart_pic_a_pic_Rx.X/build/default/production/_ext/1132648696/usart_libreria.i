# 1 "../Usart_pic_a_pic.X/usart_libreria.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../Usart_pic_a_pic.X/usart_libreria.c" 2
...
# 1 "../Usart_pic_a_pic.X/usart_libreria.h" 1
void USART_In(long BAUD);
void USART_Tx(char data);
char USART_Rx();
# 2 "../Usart_pic_a_pic.X/usart_libreria.c" 2

# 1 "../Usart_pic_a_pic.X/fuses.h" 1
# 3 "../Usart_pic_a_pic.X/usart_libreria.c" 2
# 21 "../Usart_pic_a_pic.X/usart_libreria.c"
void USART_In(long BAUD){

    TRISCbits.RC6 = 0;
    TRISCbits.RC7 = 1;

    SPBRG = (((20000000UL/BAUD)/64)-1);
    TXSTAbits.BRGH = 0;
